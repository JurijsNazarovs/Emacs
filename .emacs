...
(custom-set-variables
 ...
 '(package-selected-packages (quote (flymd markdown-mode tangotango-theme)))
 '(show-paren-mode t))
...
; Next following lines make sense just if tabs are used for indention, i.e. t not nil
;(setq tab-width 4)
...
;; Do not copy colors and font when Yank;; Do not work
